...
def birth_number(get_numerology)
case get_numerology
when 1
    message= "Your numerology number is #{get_numerology}.\nOne is the leader. The number one indicates the ability 
to stand alone, and 
is a strong vibration. Ruled by the Sun."
when 2
...
Threes enjoy life and have a good sense of humor. Ruled by Jupiter."
when 4
    message= "Your numerology number is #{get_numerology}.\nThis is the worker. Practical, with a love of detail, 
Fours are trustworthy, hard-working, and helpful. Ruled by Uranus."
when 5
    message= "Your numerology number is #{get_numerology}.nThis is the freedom lover. The number five is an intellectual 
vibration. These are idea people with 
...
These people are not very attached 
...
impractical, and sympathetic vibration. Ruled by Mars."
    ...
    message= "Sorry. You're number isn't 1-9."
    end
    
end

puts "What's your birthdate? Use MMDDYYYY format."

birthdate=gets

get_numerology=numerology(birthdate)
message=birth_number(get_numerology)
puts message
